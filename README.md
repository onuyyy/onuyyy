...
| 독크독크 | 독서모임 활동의 기록과 아카이빙에 특화된 서비스 | Java, Spring Boot, Spring Security, Spring JPA, PostgreSQL, Docker, Querydsl, React, TypeScript, Aws, Github Actions | [Repo](https://github.com/onuyyy/dokdok-server) | https://www.dokdok.site |
